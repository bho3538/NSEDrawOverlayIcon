...
public:
	...
	static BOOL XDrawOverlayAtBitmap(HBITMAP originalImage, HICON overlayIcon, LPCWSTR overlayPath, INT oImageSize, INT overlaySize, INT overlayX, INT overlayY, HBITMAP* pResult);
